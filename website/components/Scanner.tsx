...
const ctxMap = new WeakMap<HTMLDivElement, RenderContext>();
...
export const Scanner = ({
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      const mVal = program.uniforms.uMouse.value as Float32Array;
      mVal[0] = currentMouse[0];
      mVal[1] = currentMouse[1];
